...
class UI {
    addProduct(product) {
        ...
        `;
        productList.appendChild(element); //appendChild: permite agregar un hijo.
    }
    ...
    deleteProduct(element) {
        if (element.name === 'delete') {
            //parentElement : es el elemento padre del elemento.
...
document.getElementById('product-list')
    .addEventListener('click', function (e) {
        const ui = new UI();
        ui.deleteProduct(e.target); //obtiene la etiqueta del objeto
        e.preventDefault();
    });